...
const MECHANICS_GUIDES = [
    {
        ...
        content: [
            ...
            {
                type: 'list', items: [
                    '1. 优先保障人口维护物资：建造农田确保粮食供应，并尽早建设织布坊（或其他布料建筑）保证衣物/布料供给',
                    '2. 根据缺口补足基础资源：木材不足再建伐木场，避免一开始就只盯着木材',
                    '3. 建造简陋小屋提升人口上限，让人口自然增长',
                    '4. 建造图书馆积累科研点数',
                    '5. 研究"基础工具"和"车轮"科技',
                    '6. 当科研≥500且人口≥20时，准备升级到青铜时代'
                ]
            },
            { type: 'p', text: '青铜时代（10-30分钟）：' },
            {
                type: 'list', items: [
                    '1. 巩固人口维护与市场供给：持续补足粮食与衣物（布料）缺口（缺粮补农田，缺衣补织布坊/纺织类建筑）',
                    '2. 建造庄园和木屋，提升资源产出和人口上限',
                    '3. 建造市场开始贸易，积累银币（缺口资源可通过贸易临时补齐）',
                    '4. 建造兵营招募基础军队保护国家',
                    '5. 研究"封建制度"解锁更多建筑，并持续关注阶层需求，保持稳定度'
                ]
            },
            { type: 'h4', text: '💡 新手提示' },
            {
    ...
    },
    {
        ...
        content: [
            ...
            { type: 'p', text: '此外，社会阶层（如军人）的满意度会提供全局军事Buff。' },
            { type: 'h4', text: '3. 军队管理' },
            {
                type: 'list', items: [
                    '人口限制：军队人口不能超过总人口的30%',
