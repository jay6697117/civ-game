...
export const BUILDINGS = [
...

    {
        ...
        input: { furniture: 0.10, fine_clothes: 0.10, brick: 0.04 },
...

    {
        ...
        input: { fine_clothes: 0.15, brick: 0.03 },
        output: { culture: 1.20 },
        jobs: { cleric: 2 },
        owner: 'cleric',
        epoch: 1,
...

    {
        ...
        input: { papyrus: 0.40, coffee: 0.10, brick: 0.04 },
        output: { science: 1.20 },
    ...
    // 高级文化建筑
    {
        ...
        input: { papyrus: 0.30, coffee: 0.20, delicacies: 0.15, brick: 0.06 },
...

    {
        ...
        input: { fine_clothes: 0.25, delicacies: 0.20, brick: 0.05 },
