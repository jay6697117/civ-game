...
export const BUILDINGS = [
...

    {
        ...
        output: { fine_clothes: 1.2, culture: 0.15 },
        jobs: { artisan: 3 },
        owner: 'artisan',
        epoch: 1,
        cat: 'industry',
...

    {
        ...
        input: { brick: 0.20, papyrus: 0.02, delicacies: 0.10, fine_clothes: 0.05, culture: 0.03 },
        output: {},
        jobs: { official: 7 },
        epoch: 3,
        cat: 'civic',
...

    {
        ...
        output: { culture: 1.0667, silver: 0.6667 },
        jobs: { cleric: 4 },
        owner: 'cleric',
        epoch: 3,
        cat: 'civic',
...

    {
        ...
        output: { science: 0.75, culture: 0.25 },
    ...
    // ========== 探索时代新建筑 ==========
    {
        ...
        input: { food: 1.2, cloth: 0.6, spice: 0.075 },
...

    {
        ...
        name: "咖啡馆",
        desc: "啜饮咖啡、交流思想的启蒙沙龙。",
        baseCost: { plank: 140, coffee: 40, cloth: 20, delicacies: 15 },
        input: { coffee: 0.5333, delicacies: 0.2667 },
        output: { culture: 1.3333, science: 1.3333 },
...

    {
        ...
        input: { coal: 0.48, ale: 0.24, delicacies: 0.12 },
        output: { silver: 1.80, maxPop: 14 },
...

    {
        ...
        baseCost: { brick: 200, papyrus: 80, wood: 60 },
        input: { papyrus: 0.5333, coffee: 0.1333, brick: 0.0533 },
        output: { science: 1.60 },
    ...
    // 纺织产业升级线
    {
        ...
        input: { food: 1.0667, dye: 0.40 },
        output: { cloth: 6.6667, fine_clothes: 0.80 },
...

    {
        ...
        input: { cloth: 2.9167, dye: 0.5833, coal: 0.35 },
        output: { fine_clothes: 3.2667, culture: 0.35 },
        jobs: { worker: 14, artisan: 3, engineer: 1, capitalist: 1 },
        owner: 'capitalist',
        epoch: 6,
        cat: 'industry',
...

    {
        ...
        input: { plank: 2.8125, cloth: 0.9, coal: 0.2813 },
        output: { furniture: 3.9375, culture: 0.225 },
        jobs: { worker: 9, artisan: 2, engineer: 1, capitalist: 1 },
        owner: 'capitalist',
        epoch: 6,
        cat: 'industry',
    ...
    // 建材产业升级线
    {
        ...
        input: { stone: 2.25, wood: 0.675, coal: 0.225 },
        output: { brick: 6.1875 },
...

    {
        ...
        input: { brick: 1.65, steel: 0.22, stone: 1.10, coal: 0.44 },
        output: { brick: 12.10 },
        jobs: { worker: 11, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 6,
        cat: 'industry',
    ...
    // 食品加工产业升级线
    {
        ...
        input: { food: 2.8125, iron: 0.3375, coal: 0.2813 },
        output: { delicacies: 3.9375 },
        jobs: { worker: 9, artisan: 2, engineer: 1, capitalist: 1 },
        owner: 'capitalist',
        epoch: 6,
        cat: 'industry',
...

    {
        ...
        input: { food: 2.25, coal: 0.225 },
        output: { ale: 3.9375, silver: 0.90 },
    ...
    // 高级文化建筑
    {
        ...
        input: { papyrus: 0.36, coffee: 0.24, delicacies: 0.18, brick: 0.072 },
...

    {
        ...
        baseCost: { brick: 350, plank: 150, furniture: 80, culture: 40, dye: 20 },
...

    {
        ...
        input: { papyrus: 0.2286, coffee: 0.1714 },
        output: { silver: 5.7143, culture: 0.5714 },
        jobs: { merchant: 7, scribe: 2, capitalist: 2 },
        owner: 'capitalist',
        epoch: 6,
        cat: 'civic',
