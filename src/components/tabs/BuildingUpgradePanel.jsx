...
export const BuildingUpgradePanel = ({
    ...
    const upgradeMultiplier = getBuildingUpgradeCostMultiplier(difficulty);
    ...
    const canAffordUpgrade = (fromLevel) => {
        ...
        const baseCost = getUpgradeCost(buildingId, fromLevel + 1, existingUpgradeCount, growthFactor);
        const cost = {};
        if (baseCost) {
