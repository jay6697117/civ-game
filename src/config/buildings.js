...
export const BUILDINGS = [
  ...
  { 
    ...
    input: { plank: 0.50, cloth: 0.15 }, 
    output: { furniture: 0.45 }, 
    jobs: { artisan: 4 }, 
    owner: 'artisan',
    epoch: 2, 
    cat: 'industry', 
  ...
  { 
    ...
    input: { cloth: 0.6, wood: 0.1 }, 
    output: { cloth: 1.2, culture: 0.05 }, 
    jobs: { artisan: 2 }, 
    owner: 'artisan',
    epoch: 1, 
    cat: 'industry', 
