  ...
  epoch2: [
    {
      ...
      duration: 360,
      effects: {
        scienceBonus: 0.25, // 科研产出 +25%
        cultureBonus: 0.25  // 文化产出 +25%
      },
