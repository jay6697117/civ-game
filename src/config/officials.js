...
const NAME_STYLES = {
    ...
    GERMANIC: {
        ...
        last: ['霍亨索伦', '哈布斯堡', '维特尔斯巴赫', '哈耶克', '俾斯麦', '克劳塞维茨', '梅特涅', '瓦格纳', '施特劳斯', '海涅', '歌德', '席勒',
            ...
            '施莱尔马赫', '洪堡', '莱布尼茨', '奥伊勒', '冯·诺伊曼', '哈贝尔', '玻尔', '施密特', '布伦纳'],
    ...
    FRENCH: {
        ...
        last: ['波旁', '瓦卢瓦', '卡佩', '黎塞留', '马扎然', '拉法耶特', '塔列朗', '伏尔泰', '卢梭', '雨果', '巴尔扎克',
            ...
            '蒙田', '拉封丹', '拉辛', '勒克莱尔', '雷诺阿', '德彪西', '圣西门', '吉拉尔丹'],
        particles: ['德', '杜'],
        particleChance: 0.3,
        format: 'particleLastFirst'
    },
    ...
    ENGLISH: {
        ...
        last: ['丘吉尔', '克伦威尔', '惠灵顿', '纳尔逊', '莎士比亚', '牛顿', '达尔文', '狄更斯', '培根', '洛克', '霍布斯',
            ...
            '克鲁姆韦尔', '邓宁', '密尔', '斯图尔特', '华莱士', '吉布森', '柯南道尔', '哈代'],
    ...
    SLAVIC: {
        first: ['伊凡', '彼得', '亚历山大', '尼古拉', '弗拉基米尔', '鲍里斯', '米哈伊尔', '德米特里', '列夫', '安德烈',
            ...
            '安东', '费奥多尔', '伊戈尔', '瓦伦蒂娜', '奥尔加', '阿纳斯塔西娅', '格里戈里', '帕维尔'],
        last: ['罗曼诺夫', '留里克', '普希金', '托尔斯泰', '陀思妥耶夫斯基', '柴可夫斯基', '朱可夫', '加加林', '列宁', '斯大林',
            ...
            '穆辛', '斯捷潘诺夫', '科罗廖夫', '卡拉什尼科夫', '门捷列夫', '索尔仁尼琴'],
...
export const generateName = (epoch) => {
    ...
    if (epoch <= 2) {
        ...
        // 封建/启蒙：欧陆风云模式
        const styles = ['CHINESE', 'JAPANESE', 'GERMANIC', 'FRENCH', 'ENGLISH', 'SLAVIC', 'ISLAMIC', 'AFRICAN', 'INDIAN', 'MESOAMERICAN', 'NATIVE_AMERICAN'];
        styleKey = styles[Math.floor(rand * styles.length)];
    } else {
        // 工业/现代：全球化
